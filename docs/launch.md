...
>
> It is a zero-dependency Node CLI: `npx --yes github:jsxxwhai/stargap#v0.1.2 <owner/repo>`.
>
...
>
> Example: `npx --yes github:jsxxwhai/stargap#v0.1.2 astral-sh/ruff --min-stars 300`
>
